...
# =========================================================================
# CẤU HÌNH API ĐA KHU VỰC (MULTI-REGION ENDPOINTS)
# Tích hợp thông tin EU thực tế do cộng đồng cung cấp
# =========================================================================
REGIONS = {
    "vn": {
        "name": "Việt Nam",
        ...
        "auth0_audience": "https://mobile.connected-car.vinfast.vn", # VN dùng API Base làm Audience
    ...
    "us": {
        ...
        "auth0_audience": "https://mobile.connected-car.vinfastauto.us", 
        "api_base": "https://mobile.connected-car.vinfastauto.us",
        "aws_region": "us-east-1",
        "cognito_pool_id": "us-east-1:c6537cdf-92dd-4b1f-99a8-9826f153142a", # Chờ cộng đồng US xác nhận
        "iot_endpoint": "prod.iot.connected-car.vinfastauto.us" 
    },
    "eu": {
        "name": "Europe (EU)",
        "auth0_domain": "vinfast-eu-prod.eu.auth0.com",
        "auth0_client_id": "dxxtNkkhsPWW78x6s1BWQlmuCfLQrkze",
        "auth0_audience": "https://vinfast-eu-prod.eu.auth0.com/api/v2/", # Cấu trúc Audience đặc thù của EU
        "api_base": "https://mobile.connected-car.vinfastauto.eu",
        "aws_region": "eu-central-1",
        "cognito_pool_id": "eu-central-1:fcc0e952-31fe-4f06-9ab0-0a7c8b36340f", # Đã ghép chuẩn prefix region
        "iot_endpoint": "iot.connected-car.vinfastauto.eu"
    }
}

DEVICE_ID = "vfdashboard-global-edition"
...
# =========================================================================
# VIRTUAL SENSORS: CẢM BIẾN TỔNG HỢP HIỂN THỊ UI
# =========================================================================
VIRTUAL_SENSORS = {
...
VF567_SENSORS = PLATFORM_A_BASE.copy()
VF567_SENSORS.update({
