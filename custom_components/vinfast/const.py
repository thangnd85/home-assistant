...
DEFAULT_COST_PER_KWH = 4000      # Giá điện (VNĐ)
DEFAULT_EV_KWH_PER_KM = 0.12     # Mức tiêu thụ xe điện (kWh/km)
DEFAULT_GAS_PRICE = 20000        # Giá xăng (VNĐ/Lít)
...
BASE_SENSORS = {
    ...
    "api_total_charge_cost_est": ("Tổng chi phí sạc ước tính", "VNĐ", "mdi:cash-fast", "monetary"),
    "api_trip_charge_cost": ("Chi phí sạc chuyến đi", "VNĐ", "mdi:cash-fast", "monetary"),
    "api_total_gas_cost": ("Tổng chi phí xăng quy đổi", "VNĐ", "mdi:gas-station", "monetary"),
...
# =========================================================
# 3. TỪ ĐIỂN DÀNH RIÊNG CHO VF8 / VF9
# =========================================================
VF89_SENSORS = {
