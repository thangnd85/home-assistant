...
class RaspberryChargerSensor(Entity):
    ...
    def update(self):
        ...
        if _throttled == '0':
            self._description = ' Thiết bị hoạt động bình thường'
            ...
            self._description = 'Nóng quá. Hạ nhiệt đi nào.'
        else:
            self._description = 'Pi đang gặp vấn đề. Cần hạ nhiệt / thay nguồn / tắt bớt ứng dụng'
        if self._text_state:
